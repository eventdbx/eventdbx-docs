...
- When sorting by `created_at` or `updated_at`, you can pass shorthand timestamp cursors (`ts:<aggregate_type>:<aggregate_id>`) with your list options; the server expands them into full timestamp tokens before paging.
